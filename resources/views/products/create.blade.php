                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('products.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control @error('acquisition_date') is-invalid @enderror"
                                    id="acquisition_date" name="acquisition_date" value="{{ old('acquisition_date') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <label for="referensi" class="form-label">Referensi<span
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga"
                                    name="harga" value="{{ old('harga', 0) }}" min="0" step="0.01" required>
                                @error('harga')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control @error('stok_saat_ini') is-invalid @enderror"
                                    id="stok_saat_ini" name="stok_saat_ini" value="{{ old('stok_saat_ini', 0) }}" min="0"
                                    required>
                                @error('stok_saat_ini')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('category_type') is-invalid @enderror" id="category_type"
                                    name="category_type" required>
                                    <option value="persediaan" {{ old('category_type') == 'persediaan' ? 'selected' : '' }}>
                                        Persediaan (Inventory)</option>
                                    <option value="perlengkapan" {{ old('category_type') == 'perlengkapan' ? 'selected' : '' }}>Perlengkapan (Equipment)</option>
                                    <option value="peralatan" {{ old('category_type') == 'peralatan' ? 'selected' : '' }}>
                                        Peralatan (Equipment)</option>
                                </select>
                                @error('category_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('sub_category') is-invalid @enderror" id="sub_category"
                                    name="sub_category">
                                    <option value="kantor" {{ old('sub_category') == 'kantor' ? 'selected' : '' }}>Kantor
                                    </option>
                                    <option value="project" {{ old('sub_category') == 'project' ? 'selected' : '' }}>Project
                                    </option>
                                </select>
                                @error('sub_category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div id="project-number-section" class="col-md-4 mb-3"
                                style="display: {{ old('sub_category') == 'project' ? 'block' : 'none' }};">
                        ...
                        <div id="depreciation-section" class="mt-4" style="display: none;">
                            ...
                            <div class="alert alert-info">
                                <i class="bi bi-info-circle"></i> <strong>Info:</strong> Depresiasi dihitung menggunakan
                                metode garis lurus.
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('useful_life_years') }}" min="1" max="50">
